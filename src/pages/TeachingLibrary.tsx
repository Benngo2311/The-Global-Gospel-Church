...
export const TeachingLibrary: React.FC = () => {
  const { t } = useLanguage();
  return (
    <div className="min-h-screen bg-slate-50 pt-32 pb-12 px-6 flex items-center justify-center">
      <div className="text-center max-w-md">
        <BookOpen className="w-16 h-16 text-church-red mx-auto mb-6 opacity-80" />
        <h1 className="text-3xl font-serif font-bold text-slate-900 mb-4">{t({ en: 'Teaching Library', vi: 'Thư Viện Giảng Dạy' })}</h1>
